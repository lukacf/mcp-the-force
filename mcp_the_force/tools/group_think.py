...
class GroupThink(ToolSpec):
    ...
    description = (
        "Orchestrate group thinking sessions where multiple AI models (GPT-5.1 Codex, Gemini 3 Pro Preview, Claude, etc.) "
    ...
    models: List[str] = Route.adapter(  # type: ignore[assignment]
        description=(
            ...
            "chat_with_gpt5_mini, chat_with_gemini25_flash, chat_with_grok41, etc. "
