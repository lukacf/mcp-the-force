...
class TestCollaborationServiceKwargsHandling:
    ...
    def collaboration_service(self):
        ...
        mock_whiteboard.get_or_create_store = AsyncMock(return_value={"store_id": "test_store", "provider": "mock"})
    ...
    @pytest.mark.asyncio
    async def test_execute_accepts_structured_output_schema_kwarg(self, collaboration_service):
        ...
        result = await collaboration_service.execute(
            ...
            structured_output_schema={"type": "object", "properties": {"test": {"type": "string"}}}
        )
    ...
    @pytest.mark.asyncio
    async def test_execute_kwargs_dont_interfere_with_core_functionality(self, collaboration_service):
        ...
        collaboration_service.whiteboard.get_or_create_store.assert_called_once_with("flow-test")
