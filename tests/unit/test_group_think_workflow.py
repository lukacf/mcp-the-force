...
class TestGroupThinkMultiPhaseWorkflow:
    ...
    async def test_complete_multi_phase_workflow(self, collaboration_service):
        ...
        mock_tool_metadata.tool_name = "chat_with_gpt5_pro"
        ...
        with (
            ...
            result = await service.execute(
                ...
                models=["chat_with_gpt5_pro", "chat_with_gemini25_flash"],
    ...
    async def test_discussion_phase_round_robin(self, collaboration_service):
        ...
        assert "chat_with_gpt5_pro" in discussion_models
    ...
    def test_write_progress_file(self, service):
        ...
        with (
            ...
            service._write_progress_file(
                session=session,
                current_model="chat_with_gpt5_pro",
                phase="discussing",
        ...
        assert progress_data["current_model"] == "chat_with_gpt5_pro"
