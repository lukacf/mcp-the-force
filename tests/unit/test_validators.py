...
class TestParameterValidator:
    ...
    def test_validate_all_required_params(
        self, validator, sample_tool_class, tool_metadata
    ):
    ...
    def test_missing_required_param(self, validator, sample_tool_class, tool_metadata):
        ...
        with pytest.raises(
            ValueError, match="Missing required parameter: output_format"
        ):
    ...
    def test_optional_param_with_default(
        ...
        tool = sample_tool_class()
        kwargs = {"instructions": "Test", "output_format": "text", "context": []}
    ...
    def test_unknown_param_lenient_mode(
        self, validator, sample_tool_class, tool_metadata
    ):
    ...
    def test_unknown_param_strict_mode(
        self, strict_validator, sample_tool_class, tool_metadata
    ):
