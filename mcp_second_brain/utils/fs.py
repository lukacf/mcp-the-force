...
def _is_ignored(file_path: Path, gitignore_patterns: List[str], root_path: Path) -> bool:
            ...
            try:
                for root, dirs, files in os.walk(path):
                    ...
                    for file_name in files:
                        ...
                        if gitignore_patterns and _is_ignored(file_path, gitignore_patterns, path):
                            continue
