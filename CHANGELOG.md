...
- **Model Consolidation**: Streamlined model offerings from 18 to 12 tools by removing deprecated models
  - Removed: `o3`, `o3-pro`, `codex-mini`, `gpt-5.1-codex`, `grok-3-fast`, `claude-sonnet-4-20250514`, `gpt-5-pro`
  - Added: `gpt-5.2`, `gpt-5.2-pro` as the new flagship reasoning models
  - Replaced `chat_with_claude4_sonnet` references with `chat_with_claude45_sonnet` (newer 1M context model)
- **Documentation Updates**: Updated all documentation files to reflect current 12-model roster
